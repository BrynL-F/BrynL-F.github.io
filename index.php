...
<head>
  ...
  <title>Bryn Leonard-Fortune Portfolio</title>
...
<?php include "navigation.html" ?>
  <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.0/jquery.min.js'></script><script  src="./js/script.js"></script>

  <main >
    <section class= "left_flex"></section>
